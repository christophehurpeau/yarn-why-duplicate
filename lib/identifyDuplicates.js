...
function getLeafs(line, recursive = false) {
  if (recursive === false) return Object.entries(line.children);

}

export const identifyDuplicates = (yarnWhyResult, recursive = false) => {
